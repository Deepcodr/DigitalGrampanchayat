...
<?php include('./includes/nav.php')?>
    ...
    <!-- Services section -->
    <div>
        <div class="box" width="200px">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./watertank.php">Maila Suction Tanker / Water Tanker Application</a></p>
                </div>
            </div>
        </div>
        <div class="box">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./deathreg.php">Death / Birth Registration</a></p>
                </div>
            </div>
        </div>
        <div class="box">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./domicile.php">Residency / Domicile / Character / Below Poverty line Certificate Application</a></p>
                </div>
            </div>
        </div>
        <div class="box">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./birthcert.php">Birth / Death / Marriage Certificate Application</a></p>
                </div>
            </div>
        </div>
        <div class="box">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./businessnoc.php">Business No Objection Certificate Application</a></p>
                </div>
            </div>
        </div>
        <div class="box">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./constpermit.php">Construction Permit Application</a></p>
                </div>
            </div>
        </div>
        <div class="box">
            <div class="row">
                <div class="col-md-10 col-10">
                    <p><a href="./elecnoc.php">Electricity No Objection Application</a></p>
                </div>
            </div>
        </div>
    </div>
